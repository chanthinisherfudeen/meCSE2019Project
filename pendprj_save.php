...
if($name!='')
{  //,`pendprj_file`,`pendprj_month`
	$Insertquery = "INSERT INTO `tbl_pendproject`(`pendprj_uid`,`pendprj_cat`,`pendprj_name`,`pendprj_lang`,`pendprj_ide`,`pendprj_time`,`pendprj_file`,`pendprj_month`)VALUES('$uid','$login_category','$name','$lang','$ide','$time','$fileName','$month')";
...
header("location:pendprj_add.php?status=".$status);
