 ...
 <div id="boxes">
  <div style="top: 199.5px; left: 551.5px; display: none;" id="dialog" class="window"> 
    <div id="lorem">
      ...
      <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      OTP: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <input type="hidden" name="link" id="link" value="wmonth1.php">
...
<div class="wrapper row5">
  <div id="container" class="clear"> 
   ...
   <?php 
	...
	$_SESSION['cat']='Web Developer'; 
	  ?>   

    <br/>
      <table style="color:#333; font-size:14px;">
        <tr>
          <td width="300" align="center"><a href="<?php print $link; ?>?cat=2">January</a></td>
          <td width="300" align="center"><a href="<?php print $link; ?>?cat=2">February </a></td>
          <td width="300" align="center"><a href="<?php print $link; ?>?cat=2">March </a></td>
          <td width="300" align="center"><a href="<?php print $link; ?>?cat=2">April  </a></td>
        </tr>
        <tr>
           <td width="300" align="center"><a href="<?php print $link; ?>?cat=2">May</a></td>
          <td width="300" align="center"><a href="<?php print $link; ?>?cat=2">June  </a></td>
          <td width="300" align="center"><a href="<?php print $link; ?>?cat=2">July  </a></td>
          <td width="300" align="center"><a href="<?php print $link; ?>?cat=2">August   </a></td>
        </tr>
         <tr>
           <td width="300" align="center"><a href="<?php print $link; ?>?cat=2">September </a></td>
          <td width="300" align="center"><a href="<?php print $link; ?>?cat=2">October  </a></td>
          <td width="300" align="center"><a href="<?php print $link; ?>?cat=2">November  </a></td>
          <td width="300" align="center"><a href="<?php print $link; ?>?cat=2">December   </a></td>
        </tr>
      </table>
      </fieldset>
