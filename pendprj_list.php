...
<div class="wrapper row5">
  <div id="container" class="clear"> 
    ...
    <div id="homepage" class="clear" align="center">
        ...
        <a style="font-size:20px; font-family:'Times New Roman'; color:#666;">Pending Project List</a>
        <br/> <br/>
	...
	if(isset($_GET["status"]))
	{
     ...
     &nbsp;
        ...
        <?php
			...
			$sqlDept="SELECT * FROM `tbl_pendproject`  ORDER BY `pendprj_id`";
        ...
        <?php
			...
			{  //`pendprj_id``pendprj_uid``pendprj_name``pendprj_lang``pendprj_ide``pendprj_time`
				for($i=1;$i<=$rowcount;$i++)
				{	

				$res=mysql_fetch_array($rstDept);
				$crtprj_id=$res["pendprj_id"];
				$crtprj_uid=$res["pendprj_uid"];
				$crtprj_name=$res["pendprj_name"];
				$crtprj_lang=$res["pendprj_lang"];
				$crtprj_ide=$res["pendprj_ide"];
				$crtprj_time=$res["pendprj_time"];
