...
<div class="wrapper row4">
  <div id="quicknav" class="clear">
   ...
   <?php
		//`tbl_projectsearch`  `ps_user``ps_keyword``
			...
			if($login_category!='1' && $gent_otp!=$user_otp)
			{ 
 ...
 <div id="boxes">
  <div style="top: 199.5px; left: 551.5px; display: none;" id="dialog" class="window"> 
    <div id="lorem">
      <form action="otp_save.php" method="post">
      <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      OTP: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <input type="hidden" name="link" id="link" value="pmonth1.php">
  ...
  <div id="container" class="clear"> 
    ...
    <br/>
      ...
      <table style="color:#333; font-size:14px;">
        <tr>
          <td width="300" align="center"><a href="<?php print $link; ?>?cat=1">January</a></td>
          <td width="300" align="center"><a href="<?php print $link; ?>?cat=1">February </a></td>
          <td width="300" align="center"><a href="<?php print $link; ?>?cat=1">March </a></td>
          <td width="300" align="center"><a href="<?php print $link; ?>?cat=1">April  </a></td>
        </tr>
        <tr>
           <td width="300" align="center"><a href="<?php print $link; ?>?cat=1">May</a></td>
          <td width="300" align="center"><a href="<?php print $link; ?>?cat=1">June  </a></td>
          <td width="300" align="center"><a href="<?php print $link; ?>?cat=1">July  </a></td>
          <td width="300" align="center"><a href="<?php print $link; ?>?cat=1">August   </a></td>
        </tr>
         <tr>
           <td width="300" align="center"><a href="<?php print $link; ?>?cat=1">September </a></td>
          <td width="300" align="center"><a href="<?php print $link; ?>?cat=1">October  </a></td>
          <td width="300" align="center"><a href="<?php print $link; ?>?cat=1">November  </a></td>
          <td width="300" align="center"><a href="<?php print $link; ?>?cat=1">December   </a></td>
        </tr>
      </table>
      </fieldset>
