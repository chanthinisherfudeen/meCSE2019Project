 ...
 <div id="boxes">
  <div style="top: 199.5px; left: 551.5px; display: none;" id="dialog" class="window"> 
    <div id="lorem">
      ...
      <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      OTP: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <input type="hidden" name="link" id="link" value="psearch.php">
...
<?php  } ?>
    <br/>
      <table style="color:#333; font-size:14px;">
        <tr>
        <td width="300" align="center"><img src="images/companies_256.png" height="150" width="100" /><br /><a href="pmonth.php?type=current">Current Project</a></td>
          <td width="300" align="center"><img src="images/companies_256.png" height="150" width="100" /><br /><a href="pmonth.php?type=finished">Finished Project</a></td>
        </tr>
        <tr>
        <td width="300" align="center"><img src="images/companies_256.png" height="150" width="100" /><br /><a href="pmonth.php?type=pending">Pending Project</a></td>
          <td width="300" align="center"><img src="images/companies_256.png" height="150" width="100" /><br /><a href="pmonth.php?type=correction">Correction Project</a></td>
        </tr>
      </table>
      </fieldset>
