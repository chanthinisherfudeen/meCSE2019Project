...
if($name!='')
{
	//  ,`fnprj_file`,`fnprj_month
	
	$Insertquery = "INSERT INTO `tbl_fnproject`(`fnprj_uid`,`fnprj_cat`,`fnprj_name`,`fnprj_lang`,`fnprj_ide`,`fnprj_time`,`fnprj_file`,`fnprj_month`)VALUES('$uid','$login_category','$name','$lang','$ide','$time','$fileName','$month')";
...
header("location:finishedprj_add.php?status=".$status);
