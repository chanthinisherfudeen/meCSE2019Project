...
<div class="wrapper row5">
  <div id="container" class="clear"> 
    ...
    <div id="homepage" class="clear" align="center">
        ...
        <a style="font-size:20px; font-family:'Times New Roman'; color:#666;">Finished Project List</a>
        <br/> <br/>
	...
	if(isset($_GET["status"]))
	{
     ...
     &nbsp;
        ...
        <?php
			...
			$sqlDept="SELECT * FROM `tbl_fnproject`  ORDER BY `fnprj_id`";
        ...
        <?php
			...
			{  //`fnprj_id``fnprj_uid``fnprj_name``fnprj_lang``fnprj_ide``fnprj_time`
				for($i=1;$i<=$rowcount;$i++)
				{	

				$res=mysql_fetch_array($rstDept);
				$crtprj_id=$res["fnprj_id"];
				$crtprj_uid=$res["fnprj_uid"];
				$crtprj_name=$res["fnprj_name"];
				$crtprj_lang=$res["fnprj_lang"];
				$crtprj_ide=$res["fnprj_ide"];
				$crtprj_time=$res["fnprj_time"];
