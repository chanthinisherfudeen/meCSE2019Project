...
<div class="wrapper row5">
  <div id="container" class="clear"> 
    ...
    <div id="homepage" class="clear" align="center">
        ...
        <a style="font-size:20px; font-family:'Times New Roman'; color:#666;">Correction Project List</a>
        <br/> <br/>
	...
	if(isset($_GET["status"]))
	{
     ...
     &nbsp;
        ...
        <?php
			...
			$sqlDept="SELECT * FROM `tbl_corrproject`  ORDER BY `corrprj_id`";
        ...
        <?php
			...
			{  //`corrprj_id``corrprj_uid``corrprj_name``corrprj_lang``corrprj_ide``corrprj_time`
				for($i=1;$i<=$rowcount;$i++)
				{	

				$res=mysql_fetch_array($rstDept);
				$crtprj_id=$res["corrprj_id"];
				$crtprj_uid=$res["corrprj_uid"];
				$crtprj_name=$res["corrprj_name"];
				$crtprj_lang=$res["corrprj_lang"];
				$crtprj_ide=$res["corrprj_ide"];
				$crtprj_time=$res["corrprj_time"];
