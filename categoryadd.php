...
<div class="wrapper row5">
  <div id="container" class="clear"> 
    ...
    <div id="homepage" class="clear" align="center">
        ...
        <a style="font-size:20px; font-family:'Times New Roman'; color:#666;">Add Category</a>
        <br/> <br/>
	...
	if($status==3)
     ...
     &nbsp;
        ...
        <form id="frm" name="frm" action="categorysave.php" method="post" enctype="multipart/form-data">
